...
public class Servis extends Identifikacija {
	...
	public Servis(String id, Automobil servisiraniAuto, Serviser serviser, ArrayList<Deo> delovi, GregorianCalendar termin, Status status, String opis) {
		super(id);
	...
	public String toString() {
		return "Servis [servisiraniAuto=" + servisiraniAuto + ", serviser=" + serviser + ", status=" + status
				+ ", opis=" + opis + ", delovi=" + delovi + ", id=" + id +  ", termin=" + termin + "]";
	}
